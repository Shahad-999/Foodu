...
class CancelledOrdersUseCase extends BaseUseCase<List<OrderItem>, NoParam> {
  final OrdersRepository _repository;

  CancelledOrdersUseCase() : _repository = getIt.get();

  @override
  Future<Either<Failure, List<OrderItem>>> call([NoParam? param]) {
    return _repository.getCancelledOrders();
  }
